...
1. **Install the tool**: Run `./install.zsh` to create a system-wide symlink
...
- **install.zsh**: Installation script that creates symlink from `run.zsh` to `enable-config-dir` in user's PATH
